...
test_that("test both", {
  ...
  dd2 <-
    filter_actors(tabari.demo, spotter('GON', 'OSG'), which = 'both')
...
test_that("test source", {
  dd <-
    filter_actors(tabari.demo, spotter('GON', 'OSG'), which = 'source')
...
test_that("test target", {
  dd <-
    filter_actors(tabari.demo, spotter('GON', 'OSG'), which = 'target')
